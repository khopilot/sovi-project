    ...
    <section className="relative overflow-hidden">
      ...
      <div className="py-24 bg-buttercup">
        <div className="max-w-7xl mx-auto px-4">
          <motion.h2 
            className="font-karla text-headline text-gray-800 text-center mb-16 uppercase"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            What Our <span className="text-gray-900">Community Says</span>
          </motion.h2>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="relative h-full p-4 flex flex-col bg-white/90 backdrop-blur-sm transition-all duration-300 group-hover:bg-white/95">
                  ...
                  <div className="flex-grow flex items-center justify-center font-karla text-body text-gray-700">
