      ...
      <div className={styles.contentContainer}>
        <div className={styles.content}>
          <Image
            ...
            priority
          />
          <h1 className="font-karla text-headline text-fire uppercase tracking-wide mb-6">
            Experience Ancient Wisdom, Feel Modern Relief
          </h1>
          <p className="font-karla text-subheading text-ochre mb-4">
          ...
          <p className="font-karla text-subheading text-ochre mb-8">
